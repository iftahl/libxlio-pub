...
void node_data::set_style(EmitterStyle::value style)
{
    m_style = style;
}
...
// sequence
void node_data::push_back(node &node, const shared_memory_holder & /* pMemory */)
{
...
void node_data::insert(node &key, node &value, const shared_memory_holder &pMemory)
{
    switch (m_type) {
    case NodeType::Map:
        break;
...
// indexing
node *node_data::get(node &key, const shared_memory_holder & /* pMemory */) const
{
