...
template <typename T> class SettingChange : public SettingChangeBase {
public:
...
template <typename T> inline std::unique_ptr<SettingChangeBase> Setting<T>::set(const T &value)
{
