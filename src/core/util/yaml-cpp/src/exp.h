...
inline const RegEx &NotPrintable()
{
    static const RegEx e = RegEx(0) |
        RegEx("\x01\x02\x03\x04\x05\x06\x07\x08\x0B\x0C\x7F", REGEX_OR) | RegEx(0x0E, 0x1F) |
...
{
    static const RegEx e =
        Word() | RegEx("#;/?:@&=+$,_.!~*'()[]", REGEX_OR) | (RegEx('%') + Hex() + Hex());
    return e;
}
...
{
    static const RegEx e = !(BlankOrBreak() | RegEx(",[]{}#&*!|>\'\"%@`", REGEX_OR) |
...
{
    static const RegEx e = (RegEx(':') + (BlankOrBreak() | RegEx() | RegEx(",]}", REGEX_OR))) |
        RegEx(",?[]{}", REGEX_OR);
    return e;
}
